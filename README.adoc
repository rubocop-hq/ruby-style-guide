...
----
# bad
unless sweet?(fruit) && !fruit.green?
  yield fruit # skip yielding sweet non-green fruits
end
...
# good - non-inversed
if !sweet?(fruit) || fruit.green?
  yield fruit # yield non-sweet or green fruits
end
...
return unless offensive_ternary?(node)
----
